<template>
    <q-drawer v-model="sidebarOpened" show-if-above bordered :width="260" class="bg-primary shadow-7 text-blue-grey-7">
        ...
        <q-list>
            <sidebar-item v-for="(routeItem, routeIndex) in asyncRoutes" :key="routeIndex" :item="routeItem"

<template>
    <q-select :options="options" :clearable="clearable" :outline="outline" :use-input="useInput"
...
const filterFn = (val, update, abort) => {
    update(() => {
        ...
        filterOptions.value = props.options.filter(item => needleOptions.includes(item[props.options]))
    })
}
const clearFn = (val) => {

<template>
    <div class="image-cropper">
        <cropper ref="cropper" image-restriction="none" :src="source" :style="{ 'border-radius': '10px' }"
            :stencil-props="{ aspectRatio, handlersClasses, linesClasses }" :stencil-component="stencilComponent" />
    </div>
</template>
...
const props = defineProps({
    ...
    aspectRatio: { type: Number, default: '' }
})
...
const linesClasses = ref({ default: 'my-line' })

<template>
    <span>
        <q-img v-show="!useSkeleton || (!isReading && useSkeleton)" loading="lazy" spinner-color="white"
            :src="observeSrc" :ratio="ratio" :alt="alt" :fit="fit" :height="height" :width="width" :position="position"
            :class="preview && 'cursor-pointer'" @click="onPreview">
            <template #error>

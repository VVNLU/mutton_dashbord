...
import { getList, updateData, deleteData } from '@/api/vendorsClassification'
import VendorsListSearchBlock from './components/VendorsClassificationListSearchBlock.vue'
import VendorsDialog from './components/VendorsClassificationDialog.vue'
...
const { dataTable, search, data, total, onChangePage, onChangeFilter, OnChangeSort, onReset } = useVxeServerDataTable({
  searchParams: filter,
  sortParams: [{ field: 'sequence', order: 'desc', }],

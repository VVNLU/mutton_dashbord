    ...
    <base-form ref="form">
      <div class="row q-col-gutter-x-md">
        <div class="row q-col-gutter-x-md">
          ...
          <div class="col-xs-12 col-sm-6 col-md-6">
            <text-input v-model="data.state.name" class="full-width" label="聯絡人 *" placeholder="請輸入聯絡人"
              :modelValue="null" :required="true" />
          </div>
          <div class="col-xs-12 col-sm-6 col-md-6">
          ...
          <div class="col-xs-12 col-sm-6 col-md-6">
            <text-input v-model="data.state.remark" class="full-width" label="備註" placeholder="請輸入備註" :modelValue="null"
              :required="false" />
          </div>
        </div>
      </div>
